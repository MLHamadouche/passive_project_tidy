...
df4 = df4.groupby((df4['log10(M*/Msun)']>10.4)&(df4['log10(M*/Msun)']<=11.5)).get_group(True) #10.3<m<11.5 = 61 objects, 10.4<m<11.5 =55
...
vandels_relation = vdw_relation(vandels_c_0_75, 0.71, np.linspace(9.8, 11.5, len(stricter_sizes)))
...
print("\n Finding stats for D4000 above + below Wu et al. relation for LEGA-C galaxies:")
...
print(d4000_i_above,d4000_i_below)
...
print('LEGA-C: \n ABOVE Wu et al. 18 relation: \n std = ', legac_std_ab , '\n mean = ', legac_mean_ab, '\n median = ', legac_median_ab,
'\n BELOW Wu et al. 18 relation: \n std = ', legac_std_be , '\n mean = ', legac_mean_be, '\n median = ', legac_median_be)
...
plt.xlim(10.0, 11.8)
plt.ylim(-0.7, 1.5)
plt.savefig('vdw_0_75_legac_wu_vandels_d4000.pdf')
